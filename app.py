...
# Load Model
import joblib 
pipe_lr = joblib.load(open("./model/emotion_classifier_pipe_lr_18_june_2023.pkl","rb"))
		...
		if submit_text:
			if not raw_text:
				...
				with st.expander('Emotion Classifier Metrics'):
					...
					# Additional Plotly Pie Chart
					fig = px.pie(prediction_count, values='Counts', names='Prediction')
